...
class TestKmcIntersect(unittest.TestCase):
	...
	def test_kmc_intersect_command(self):
		k = KmcIntersect('first_database','second_database', os.getcwd(), 1, 'results', False  )
	...
	def test_kmc_intersect_command_verbose(self):
		k = KmcIntersect('first_database','second_database', os.getcwd(), 1, 'results', True  )
	...
	def test_running_intersection_and_counting_kmers(self):
		...
		k = KmcIntersect(first_db,second_db, os.getcwd(), 1, 'results', False  )
